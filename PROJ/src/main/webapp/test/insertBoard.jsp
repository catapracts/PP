...
<main>
<center><h1 style="font-size:40px">유닛 벨런스 게시판 - 새 글 등록</h1></center>
<form method = "post" action = "insertBoard.board">
<center>
<table border="10px solid black" cellpadding="10" cellspacing="0" class="divide">
