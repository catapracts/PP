...
public class MembersDAO 
{
	...
	//sql 쿼리를 적용하는 상수 선언 
	private final String MEMBERS_LOGIN = "select * from member where id = ? and pw = ?"; 
	...
	private final String MEMBERS_GET = "select id, email from member where id = ?" ; 
		
	// DB의 Member 테이블의 업데이트 쿼리 
	private final String MEMBERS_UPDATE = "update member set email= ? where id = ?"; 
