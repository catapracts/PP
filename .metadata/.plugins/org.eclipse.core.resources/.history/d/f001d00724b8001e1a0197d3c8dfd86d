...
// http://localhost:8081/PROJ/*.member
@WebServlet ("*.member")
public class MembersController extends HttpServlet 
{
   ...
   public MembersController() 
   {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{
			System.out.println("login.member 요청 처리");
		...
		{
			System.out.println("/logout.member 요청 처리 ");
			...
			//뷰페이지로 이동 (처음 페이지로 이동)
			response.sendRedirect("http://localhost:8081/FE/index.html"); 
		}
		
		
		else if (path.equals("/insertMembers.member")) 
		{
			System.out.println("insertMembers.member 요청 처리");
			//로직 처리 
		...
		else if (path.equals("/getMembersList.member")) 
		{		// DB의 레코드를 출력 하는 페이지 
			System.out.println("/getMembersList.member 요청");
			//로직 처리 
		...
		else if (path.equals("/getMembers.member")) 
		{
			System.out.println("/getMembers.member 요청");
			//로직 처리 
		...
		else if (path.equals("/updateMembers.member")) 
		{
			System.out.println("/updateMembers.member 요청");
			//로직 처리 
		...
		else if (path.equals("/deleteMembers.member")) 
		{
			System.out.println("/deleteMembers.member 요청");
			//로직 처리 
