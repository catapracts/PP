...
<%
 ...
 try
 {
	boardList = (List<Board2DTO>) session.getAttribute("boardList");
  ...
  <header class="top-bar con-min-width">
    ...
    background-size: cover;">
      ...
      <ul class="menu-main flex">
        ...
        <li><a class="flex items-center h-full" href="getBoardList.jsp">
            <span>게시판</span>
          </a>
          <nav class="menu-1">
            <ul class="menu-2">
        ...
        <li><a class="flex items-center h-full" href="/FE/History.html">
            <span>자료실</span>
          </a>
          <nav class="menu-1">
            <ul class="menu-2">
...
<main>
<center><h1 style="font-size:40px">AI대전 게시판</h1></center>
<center><table border = "1" class = "divide">
...
<% for(Board2DTO k : boardList) { %>

<tr>
<td align = "center"><%=k.getId() %>></td>
<td><a href = "getBoard.board2?id=<%=k.getId()%>"><%= k.getTitle() %></a></td>
<td><%=k.getWrite() %></td>
<td><%=k.getRegdate() %></td>
</tr>
<%
...
<p /> <a href= "insertBoard2.jsp"> 새 글쓰기</a>
<p /> <a href= "deleteBoard2.jsp"> 글 삭제</a>
</center>
</main>
