...
board = (Board2DTO) session.getAttribute("board");
%>
...
<main>
<center><h1 style="font-size:40px">유닛 벨런스 게시판 - 수정 & 상세 페이지</h1></center>
<hr><br><br>
<center>
<form method = "post" action = "updateBoard.board2">
