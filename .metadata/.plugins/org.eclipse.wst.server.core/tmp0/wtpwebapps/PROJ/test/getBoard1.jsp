...
board = (Board1DTO) session.getAttribute("board");
%>
...
<main>
<center><h1 style="font-size:40px">캠페인 공략 게시판 - 수정 & 상세 페이지</h1></center>
<hr><br><br>
<center>
<form method = "post" action = "updateBoard.board1">
...
<br><br>
<a href="deleteBoard.board1?id=<%= board.getId() %>">글 삭제</a>

<p /> <a href="http://localhost:8081/FE/index.html">홈으로</a>
<p /> <a href= "getBoardList1.jsp"> 글 목록</a>
<p /> <a href= "insertBoard1.jsp"> 새 글쓰기</a>
<p /> <a href= "deleteBoard1.jsp"> 글삭제</a>
</center>
</main>
