...
<head>
    ...
    <title>UnitBalance</title>

    <link rel="stylesheet" href="Header.css">
    <link rel="stylesheet" href="Footer.css">
    <link rel="stylesheet" href="AreaExtension_snip1200.css">
...
<body>
  ...
  <header class="top-bar con-min-width">
    ...
    background-image: url(img/aoe2/680251.jpg);
    background-size: cover;">
      ...
      <ul class="menu-main flex">
        <li><a class="flex items-center h-full" href="index.html">
            <span>ë©ì¸íì´ì§</span>
          </a>
        </li>
        <li><a class="flex items-center h-full" href="Rules.html">
            <span>ì´ìê·ì¹</span>
          </a>
        </li>
        <li><a class="flex items-center h-full" href="UnitBalance.html">
            <span>ê²ìí</span>
          </a>
          <nav class="menu-1">
            <ul class="menu-2">
              <li><a href="UnitBalance.html"><span>ì ëë°¸ë°ì¤</span></a></li>
              <li><a href="Campaign.html"><span>ìº íì¸ê³µëµ</span></a></li>
              <li><a href="AI.html"><span>AIëì </span></a></li>
            </ul>
          </nav>
        </li>
        <li><a class="flex items-center h-full" href="#">
          ...
          <nav class="menu-1">
            <ul class="menu-2">
              <li><a href="History.html"><span>ì­ì¬ ê³ ì¦ ìë£ëª¨ì</span></a></li>
              <li><a href="GameHistory.html"><span>ê²ì ì­ì¬</span></a></li>
            </ul>
          </nav>
        </li>
        <li><a class="flex items-center h-full" href="Q&A.html">
            <span>Q&A</span>
          </a>
        </li>
        <li><a class="flex items-center h-full" href="Notice.html">
            <span>ê³µì§ì¬í­</span>
          </a>
        </li>
      </ul>
...
<td><a href = "getBoard.board?id=<%=k.getId()%>"><%= k.getTitle() %></a></td>
<td><%=k.getWrite() %></td>
<td><%=k.getRegdate() %></td>
</tr>
<%
...
{
	response.sendRedirect("/test/getBoardList.jsp");
	e.printStackTrace();
}
%>
</table>
...
<p /> <a href= "deleteBoard.jsp"> 글 삭제</a>
    ...
    <rect width="20" height="20" fill="white" transform="translate(0 0.5)"/>
          ...
          <li>
            ...
            <li>
            <span style="font-style: italic;">ê¶ê¸í ê²ì´ ìì¼ì ê°ì?
              <a href="Q&AEdition.html">ìì£¼ ë¬»ë ì§ë¬¸</a>
              </span>
              </li>
